...
🔒 Safety & Ethics
✅ Safe for portfolios and demonstrations ✅ Runs entirely in the browser (no backend required) ✅ No real authentication systems are attacked ✅ No credentials are collected or stored ✅ Educational disclaimers throughout
...
Lucide React - Icons
📚 How It Works
Enter a Password: Input any password you want to test
Configure Defenses: Enable/disable security mechanisms
Run Simulation: Watch as the system attempts to crack the password
